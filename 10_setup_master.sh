...
sudo ln -s /vagrant/manifests/site.pp /etc/puppet/manifests/site.pp; \
sudo ln -s /vagrant/hiera.yaml /etc/puppet/hiera.yaml; \
sudo mkdir -p /etc/puppet/hieradata; \
sudo ln -s /vagrant/hieradata/common.yaml /etc/puppet/hieradata/common.yaml; \
